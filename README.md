...
If you want to contribute to the code to fix bugs/ add functionalities you can first be aware of the current issues in the issues section of the repository or directly send a pull request.

You can contact me on discord  for more info , more informations will be provided about contributing.
